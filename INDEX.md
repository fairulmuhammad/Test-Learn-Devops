...
- 2026-08-14: Capstone LIVE — pushed to github.com/fairulmuhammad/Test-Learn-Devops, self-hosted runner wannacry-server registered (v2.336.0), CI green on GitHub runners, CD green on box runner (deploy via docker compose up -d --build, /health verified).
